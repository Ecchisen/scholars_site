...
import Gallery from "./pages/Gallery"; // Corrected import path
...
const App = () => (
  <QueryClientProvider client={queryClient}>
    <TooltipProvider>
      <Toaster />
      <Sonner />
      <BrowserRouter basename="/scholars_site"> {/* Added basename prop */}
        <Layout> {/* Wrap routes with the Layout component */}
          <Routes>
            ...
            {/* <Route path="/faculty" element={<Faculty />} /> */} {/* Removed Faculty route */}
